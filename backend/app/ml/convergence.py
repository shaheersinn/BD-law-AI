...
SIGNAL_CATEGORIES: dict[str, str] = {
    **{k: "filings" for k in ["sedar_material_change", "sedar_business_acquisition",
       "sedar_confidentiality", "sedar_cease_trade", "sedar_going_concern",
       "sedar_auditor_change", "sedar_director_resign", "edgar_conf_treatment",
       "edgar_sc13d", "edgar_merger_confirmed", "edgar_8k"]},
    **{k: "litigation" for k in ["canlii_defendant", "canlii_plaintiff",
       "canlii_class_action", "canlii_ccaa", "canlii_injunction", "canlii_tribunal"]},
    **{k: "enforcement" for k in ["osc_enforcement", "osfi_supervisory",
       "competition_investigation", "fintrac_noncompliance",
       "health_canada_recall", "eccc_enforcement", "competitor_hit_same_industry"]},
    **{k: "jobs" for k in ["job_gc_hire", "job_cco_urgent", "job_privacy_counsel",
       "job_ma_counsel", "job_litigation_counsel", "job_deputy_gc_regulatory",
       "job_environmental_counsel"]},
    **{k: "geospatial" for k in ["jet_baystreet_2x", "satellite_parking_drop",
       "permit_environmental", "permit_construction", "foot_traffic_competitor"]},
    **{k: "news" for k in ["news_lawsuit", "news_investigation", "news_layoffs",
       "news_data_breach", "news_merger", "news_exploring_strategic",
       "news_legal_proceedings"]},
    **{k: "people" for k in ["linkedin_gc_spike", "linkedin_gc_posts_legal",
       "linkedin_exec_departure", "linkedin_mass_exits", "linkedin_gc_connected_restr"]},
}
...
def threshold_label(score: float) -> Optional[str]:
...
def crossed_threshold(prev: float, curr: float) -> Optional[str]:
