...
_TIER2_FIRMS = [
    FirmConfig("miller_thomson", "Miller Thomson LLP", 2,
    ...
    FirmConfig("borden_elliot", "Borden Elliot", 2,
               "https://borderelliott.com/feed/",
               ["insolvency", "litigation", "banking"],
               "https://borderelliott.com"),
    FirmConfig("davies", "Davies Ward Phillips & Vineberg", 2,
               "https://www.dwpv.com/en/insights/rss",
               ["securities", "ma", "competition", "tax"],
               "https://www.dwpv.com"),
    FirmConfig("lenczner_slaght", "Lenczner Slaght", 2,
               "https://litigate.com/feed/",
               ["litigation", "arbitration", "class_actions"],
               "https://litigate.com"),
    FirmConfig("thornton_grout", "Thornton Grout Finnigan", 2,
               "https://www.tgf.ca/feed/",
               ["insolvency", "litigation", "banking"],
               "https://www.tgf.ca"),
    FirmConfig("lax_oleary", "Lax O'Leary LLP", 2,
               "https://laxoleary.ca/feed/",
               ["litigation", "securities", "class_actions"],
               "https://laxoleary.ca"),
    FirmConfig("borden_elliot2", "Borden Elliot (Insolvency)", 2,
               "https://borderelliott.com/feed/",
               ["insolvency"],
               "https://borderelliott.com"),
    FirmConfig("ogilvy", "Ogilvy Renault (merged to Norton Rose)", 2,
               "https://www.nortonrosefulbright.com/en-ca/insights/rss",
               ["regulatory", "financial_regulatory"],
               "https://www.nortonrosefulbright.com"),
    FirmConfig("fraser_milner", "Dentons (formerly Fraser Milner Casgrain)", 2,
               "https://www.dentons.com/en/ca/insights/rss",
               ["energy", "mining", "regulatory"],
               "https://www.dentons.com"),
    FirmConfig("langford", "Langford Law", 2,
               "https://langfordlaw.ca/feed/",
               ["employment", "litigation"],
               "https://langfordlaw.ca"),
    FirmConfig("goldman_sloan", "Goldman Sloan Nash & Haber", 2,
               "https://gsnh.com/feed/",
               ["competition", "regulatory"],
               "https://gsnh.com"),
    FirmConfig("lerners", "Lerners LLP", 2,
...
class LawFirmBlogScraper(BaseScraper):
    ...
    async def scrape(self) -> list[ScraperResult]:
        ...
        try:
            ...
            log.error("lawblog_scrape_error",
                      firm=self._firm.firm_id, error=str(exc))
    ...
    def _parse_html(self, html: str) -> list[ScraperResult]:
        ...
        try:
            ...
            selectors = [
                ...
                ".blog-post h2 a", ".insight h2 a",
                ".publication-title a", ".news-item a",
    ...
    def _classify_content(self, text: str) -> list[str]:
        ...
        area_keywords = {
            ...
            "competition": ["competition", "antitrust", "cartel", "abuse of dominance", "merger review"],
...
def _make_firm_scraper_class(firm: FirmConfig) -> type:
    ...
    scraper_cls = type(class_name, (LawFirmBlogScraper,), {
