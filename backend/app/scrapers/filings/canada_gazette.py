...
GAZETTE_KEYWORDS = {
    ...
    "environmental_indigenous_energy": ["environment", "carbon", "emissions", "indigenous", "energy"],
    ...
    async def run(self) -> list[SignalData]:
        ...
        for entry in feed.get("entries", [])[:30]:
            ...
            signals.append(SignalData(
                ...
                raw_entity_name="Canada Gazette",
                title=title,
                summary=summary[:500],
                source_url=link,
                ...
                metadata={"gazette_part": "II", "source": "canada_gazette"},
            ))
        return signals
