...
Endpoints:
    GET  /api/v1/bd/partners                        List partner users
    GET  /api/v1/bd/partner-coaching/{partner_id}   Coaching insights for a partner
    GET  /api/v1/bd/pitch-history                   Pitch history (future: mandate_pitches table)
    GET  /api/v1/bd/associate-activity              Associate activity summary
    GET  /api/v1/bd/writing-samples/{partner_id}    Writing samples (future: writing_samples table)
    GET  /api/v1/bd/content                         BD content library (future: bd_content table)
    POST /api/v1/bd/inquiries                       Log a BD inquiry
"""
