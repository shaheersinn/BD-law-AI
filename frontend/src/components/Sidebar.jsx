/**
 * components/Sidebar.jsx — Digital Atelier icon-rail navigation.
 *
 * Narrow ~80px icon rail. Active state uses surface-container-lowest bg
 * with on-secondary-container colour and radius-xl. Hover transitions fast.
 * All icons from lucide-react (NO Material Symbols).
 */
  ...
  return (
    <aside style={{
      ...
      <nav style={{
        ...
        <NavItem to="/feedback"              icon={MessageSquare}   label="FDBK" />
        {isAdmin && (
          <NavItem to="/admin/scrapers" icon={Database} label="ADMN" />
        )}
      </nav>
