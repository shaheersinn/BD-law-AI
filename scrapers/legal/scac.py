    ...
    async def scrape(self) -> list[ScraperResult]:
        ...
        try:
            ...
            for row in rows[:50]:
                ...
                link = row.find("a")
                url = f"https://securities.stanford.edu{link['href']}" if link and link.get("href") else None
                results.append(ScraperResult(
                    source_id=self.source_id, signal_type="litigation_class_action",
