...
class TribunalsOntarioScraper(BaseScraper):
    ...
    rate_limit_rps = 0.2; concurrency = 1; ttl_seconds = 86400
        ...
        try:
            ...
            for rec in data.get("result", {}).get("records", []):
                ...
                results.append(ScraperResult(
                    source_id=self.source_id, signal_type="litigation_tribunal_decision",
                    signal_value={"tribunal": tribunal, "date": rec.get("date"), "applicant": rec.get("applicant_type")},
