...
class GoogleTrendsScraper(BaseScraper):
    ...
    signal_types = ["geo_trends_legal_spike", "geo_trends_employment_spike",
                    "geo_trends_insolvency_spike", "geo_trends_litigation_spike"]
